...
var tasks_worker = {
    ...
    */
    spawn: function(type, body) {
        ...
        return new Task(C.TASK_TYPE_REALTIME, C.SPAWN, 2, handlerKey, [1, 2], para_in);
    },
    ...
    */
    harvestEnergy: function(id) {
        ...
        return new Task(C.TASK_STATE_PENDING, C.WORKER, 8, handlerKey, [4, 2, 3, 4, 5, 6, 7, 1], para_in);
    },
    ...
    */
    upgradeController: function(level) {
        ...
        return new Task(C.TASK_TYPE_REALTIME, C.WORKER, 8, handlerKey, [4, 2, 3, 4, 5, 6, 7, 1], para_in);
    },
    ...
    */
    buildStruct: function() {
        ...
        return new Task(C.TASK_TYPE_DYNAMIC, C.WORKER, 7, handlerKey, [4, 2, 3, 4, 5, 6, 0], para_in);
    },
};
